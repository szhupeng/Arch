...
public final class NetworkUtils {
     ...
     * @return
     */
    public static boolean isNetworkValid(final Context context) {
     ...
     * @return
     */
    public static boolean checkIsWifi(final Context context) {
        ConnectivityManager connectivity = (ConnectivityManager) (context.getSystemService(Context.CONNECTIVITY_SERVICE));
        if (connectivity != null) {
     ...
     */
    public static void enableData(final Context context, final boolean enabled) {
        try {
            TelephonyManager tm = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
     ...
     * @param enabled {@code true}: 打开<br>{@code false}: 关闭
     */
    public static void enableWifi(final Context context, final boolean enabled) {
        @SuppressLint("WifiManagerLeak")
        WifiManager wifiManager = (WifiManager) context.getSystemService(Context.WIFI_SERVICE);
        if (enabled) {

...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    protected BaseAdapter baseQuickAdapter;
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        if (recyclerView == null) {
            ...
            this.baseQuickAdapter = (BaseAdapter) recyclerView.getAdapter();
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        if (baseQuickAdapter == null) {
            if (recyclerView != null) {
                baseQuickAdapter = (BaseAdapter) recyclerView.getAdapter();
            } else {
                return false;
            }
        }
        int viewType = baseQuickAdapter.getItemViewType(position);
        return (BaseAdapter.TYPE_HEADER_VIEW == viewType || BaseAdapter.TYPE_LOADMORE_VIEW == viewType || BaseAdapter.TYPE_FOOTER_VIEW == viewType);
    }

    private boolean isHeaderOrFooterView(int viewType) {
        return (BaseAdapter.TYPE_HEADER_VIEW == viewType || BaseAdapter.TYPE_LOADMORE_VIEW == viewType || BaseAdapter.TYPE_FOOTER_VIEW == viewType);
    }
}

...
public class MaterialProgressBar extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.MaterialProgressBar_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.MaterialProgressBar_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.MaterialProgressBar_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MaterialProgressBar_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.MaterialProgressBar_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.MaterialProgressBar_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MaterialProgressBar_barColor, barColor);

        rimColor = a.getColor(R.styleable.MaterialProgressBar_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.MaterialProgressBar_linearProgress, false);

        if (a.getBoolean(R.styleable.MaterialProgressBar_progressIndeterminate, false)) {
            spin();
        }
